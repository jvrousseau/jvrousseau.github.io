...
Sure, I can shove a shitload of observations into turfjs and process everything in the browser. The GIS analysis will eventually complete and results will show up on the map. However, if this is not performant, what good does the application do? You just have real-time processing in the browser for the sake of having real-time processing in the browser. This is not to say, do not use turfjs in the browser ([MapBox](http://mapbox.com/blog) has built some great [examples](https://www.mapbox.com/blog/playback-the-iditarod-with-turf/)). Just be smart with where you use turfjs and ensure the best possible experience for the end user.
